...
namespace vk
{
	struct Surface : public VkObject<VkSurfaceKHR>
	{
		...
		bool Queried() { return formats && presentModes; }
	...
	struct Swapchain : public VkObject<VkSwapchainKHR>
	{
		...
		VkResult AcquireNextImage(uint32_t& imageIndex, VkSemaphore semaphore = nullptr, VkFence fence = nullptr, uint32_t timeout = UINT64_MAX)
		{
